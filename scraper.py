#!/usr/bin/env python3
"""
X (Twitter) Scraper - Scrape X/Twitter posts, profiles, followers without API
Open source scraper for x scraper, twitter scraper, x.com scraper, scrape twitter
...
class XScraperScraper:
    """Scraper for X (Twitter) Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="X (Twitter) Scraper - Scrape X/Twitter posts, profiles, followers without API")
    ...
    scraper = XScraperScraper(proxy=args.proxy)
